...
def init():
    return [(datetime.datetime(2022, 1, 20), datetime.datetime(2022, 3, 7)),
        (datetime.datetime(2022, 4, 18), datetime.datetime(2022, 5, 16)),
        (datetime.datetime(2022, 1, 1), datetime.datetime(2022, 5, 28)),
        (datetime.datetime(2022, 1, 22), datetime.datetime(2022, 2, 7)),
        (datetime.datetime(2022, 2, 10), datetime.datetime(2022, 4, 18)),
        (datetime.datetime(2022, 2, 21), datetime.datetime(2022, 6, 12)),
        (datetime.datetime(2022, 4, 2), datetime.datetime(2022, 6, 7)),
        (datetime.datetime(2022, 5, 16), datetime.datetime(2022, 5, 26)),
        (datetime.datetime(2022, 3, 19), datetime.datetime(2022, 4, 21)),
        (datetime.datetime(2022, 6, 3), datetime.datetime(2022, 6, 12))]
...
def within_deadline(d1,d2, span):
    """
    ...
    that_day = d1 + datetime.timedelta(days = span)
    if d2<that_day: 
	    return True     
